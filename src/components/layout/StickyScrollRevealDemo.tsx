  ...
  <div className="h-full w-full bg-zinc-950 p-4 overflow-hidden">
    ...
    <div className="flex items-center justify-between mb-4">
      <div className="flex items-center gap-2">
        ...
        <span className="text-sm font-bold text-white">Auto-Fix Engine</span>
      </div>
      <span className="px-2 py-0.5 text-[9px] font-medium rounded-full bg-green-500/10 text-green-400">Ready</span>
    </div>
    ...
    <div className="space-y-2">
      <div className="p-3 bg-zinc-900/80 border border-zinc-800 rounded-xl">
        <div className="flex items-center gap-2 mb-2">
          ...
          <span className="text-[10px] font-semibold text-white">SQL Injection Vulnerability</span>
        </div>
        <div className="p-2 bg-black/40 rounded font-mono text-[8px] text-green-400 mb-2">
        ...
        <div className="flex items-center gap-2">
          <button className="px-2 py-1 bg-amber-500/20 text-amber-400 text-[9px] font-medium rounded-lg flex items-center gap-1">
            <Zap className="w-2.5 h-2.5" /> Apply Fix
          </button>
          <span className="text-[9px] text-zinc-500">auth/login.ts:42</span>
        </div>
      </div>
      ...
      <div className="p-3 bg-zinc-900/80 border border-zinc-800 rounded-xl">
        <div className="flex items-center gap-2 mb-2">
          ...
          <span className="text-[10px] font-semibold text-white">Unhandled Promise Rejection</span>
        </div>
        <div className="p-2 bg-black/40 rounded font-mono text-[8px] text-green-400 mb-2">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-[9px] text-zinc-500">api/users.ts:87</span>
        </div>
      </div>

      <div className="mt-3 p-3 bg-gradient-to-br from-amber-500/10 to-orange-500/10 border border-amber-500/20 rounded-xl">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            <GitBranch className="w-3 h-3 text-amber-400" />
            <span className="text-[10px] font-medium text-white">Create Auto-Fix PR</span>
          </div>
          <span className="text-[9px] text-amber-400">2 fixes ready</span>
        </div>
      </div>
    </div>
  </div>
...
const AnalyticsPreview = () => (
  <div className="h-full w-full bg-zinc-950 p-4 overflow-hidden">
    ...
    <div className="grid grid-cols-3 gap-2 mb-3">
      <div className="p-2.5 bg-zinc-900/80 border border-zinc-800 rounded-xl text-center">
        <p className="text-lg font-bold text-white">92</p>
        <p className="text-[9px] text-zinc-500">Health Score</p>
      </div>
      <div className="p-2.5 bg-zinc-900/80 border border-zinc-800 rounded-xl text-center">
        <p className="text-lg font-bold text-green-400">↓ 45%</p>
        <p className="text-[9px] text-zinc-500">Issues Down</p>
      </div>
      <div className="p-2.5 bg-zinc-900/80 border border-zinc-800 rounded-xl text-center">
        <p className="text-lg font-bold text-cyan-400">247</p>
        <p className="text-[9px] text-zinc-500">Reviews</p>
      </div>
    </div>
    ...
    <div className="p-3 bg-zinc-900/80 border border-zinc-800 rounded-xl mb-3">
      <div className="flex items-center gap-2 mb-2">
        ...
        <span className="text-[10px] font-medium text-white">Issue Trend</span>
      </div>
    ...
    <div className="p-3 bg-gradient-to-br from-cyan-500/10 to-blue-500/10 border border-cyan-500/20 rounded-xl">
      <span className="text-[10px] font-medium text-white">Top Categories</span>
      <div className="space-y-1.5 mt-2">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-1">
            ...
            <span className="text-[9px] text-zinc-500">75%</span>
          </div>
        </div>
        <div className="flex items-center justify-between">
          <span className="text-[9px] text-zinc-400">Performance</span>
          <div className="flex items-center gap-1">
            <div className="w-16 h-1.5 bg-zinc-800 rounded-full overflow-hidden">
              <div className="w-[45%] h-full bg-amber-400 rounded-full" />
            </div>
            <span className="text-[9px] text-zinc-500">45%</span>
          </div>
        </div>
      </div>
    </div>
  ...
  <div className="h-full w-full bg-zinc-950 p-4 overflow-hidden">
    ...
    <div className="flex items-center justify-between mb-4">
      <div className="flex items-center gap-2">
        ...
        <span className="text-sm font-bold text-white">Email Reports</span>
      </div>
    </div>

    {/* Email Preview */}
    <div className="p-3 bg-zinc-900/80 border border-zinc-800 rounded-xl mb-2">
      <div className="flex items-center gap-2 mb-2">
        <Shield className="w-3 h-3 text-violet-400" />
        <span className="text-[10px] font-semibold text-white">Code Analysis Report</span>
      </div>
      <div className="space-y-1.5">
        <div className="flex items-center gap-2">
          <FileSearch className="w-3 h-3 text-zinc-500" />
          <span className="text-[9px] text-zinc-400">react-dashboard • main branch</span>
        </div>
        <div className="flex items-center gap-2">
          <Sparkles className="w-3 h-3 text-zinc-500" />
          <span className="text-[9px] text-zinc-400">156 files analyzed, 3 issues found</span>
        </div>
      </div>
      <div className="mt-2 pt-2 border-t border-zinc-800/50 space-y-1">
        <div className="flex items-center gap-1.5">
          <div className="w-1.5 h-1.5 rounded-full bg-red-400" />
          <span className="text-[9px] text-zinc-300">1 critical: SQL injection in auth.ts</span>
        </div>
        <div className="flex items-center gap-1.5">
          <div className="w-1.5 h-1.5 rounded-full bg-orange-400" />
          <span className="text-[9px] text-zinc-300">2 high: Unvalidated inputs</span>
        </div>
      </div>
    </div>

    <div className="p-3 bg-gradient-to-br from-violet-500/10 to-purple-500/10 border border-violet-500/20 rounded-xl">
      <div className="flex items-center gap-2">
        <Mail className="w-3 h-3 text-violet-400" />
        <span className="text-[10px] font-medium text-white">Automated on every push</span>
      </div>
      <p className="text-[9px] text-zinc-500 mt-1">Detailed reports sent to your inbox with actionable fixes</p>
    </div>
  </div>
);
